 ...
 * @author mzechner
 * @author Nathan Sweet */
public class ScrollPaneN extends WidgetGroup {
	protected static final String TAG = "scroll pane n";
	...
	public ScrollPaneN (Actor widget) {
		this(widget, new ScrollPaneStyle());
	}

	/** @param widget May be null. */
	public ScrollPaneN (Actor widget, Skin skin) {
		this(widget, skin.get(ScrollPaneStyle.class));
	}

	/** @param widget May be null. */
	public ScrollPaneN (Actor widget, Skin skin, String styleName) {
		this(widget, skin.get(styleName, ScrollPaneStyle.class));
	}

	/** @param widget May be null. */
	public ScrollPaneN (Actor widget, ScrollPaneStyle style) {
		...
		addCaptureListener(new InputListener() {
			...
			public boolean touchDown (InputEvent event, float x, float y, int pointer, int button) {
				...
				getStage().setScrollFocus(ScrollPaneN.this);
	...
	/** The style for a scroll pane, see {@link ScrollPaneN}.
	 * @author mzechner
	 * @author Nathan Sweet */
